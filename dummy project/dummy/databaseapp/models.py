...
class resources_t(models.Model):
    room_capacity = models.IntegerField(db_column='room_capacity', primary_key=True, null=False, blank=False)
    room_count = models.IntegerField(db_column='room_count', blank=False, null=False)
